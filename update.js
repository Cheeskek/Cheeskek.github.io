...
function draw() {
    ...
    if (screen == 0) {
        ...
        text('Также можно отбивать пули противника мечом, если сменить оружие', 80, 450)
        textSize(24);
        text('УПРАВЛЕНИЕ', 230, 480);
        textSize(16);
        ...
        text('L Shift - сменить оружие', 60, 595);
        ...
        text('Ходьба', 425, 575);
        text('R Ctrl - сменить оружие', 385, 595);
        text('5', 545, 520);
        text('1   2   3', 525, 545);
        text('Стрельба', 515, 575);
        text('Num', 565, 500);
        text('Pad', 565, 520)
        text('Пробел / Num0 -', 260, 500);
        text('замедление', 260, 520);
        text('Escape - пауза', 265, 550);
